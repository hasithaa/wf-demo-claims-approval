...
|---|---|---|
| `wso2-integration-control-plane-2.0.0-SNAPSHOT.zip` | `hasithaa/integration-control-plane`, local merge `icp-demo-all` = upstream main + `workflow-instance-graph` (PR wso2#851) + `workflow-metrics` (PR wso2#870) | `icp-demo-all` @ `88dd39522` merging 851 @ `e7a01cab5` and 870 @ `017b2514d` (Workflows section gains the AI Agent Steps table and control-operation counts; `tool_name`/`error_type` mapped in the index template) — 2026-09-11 |
